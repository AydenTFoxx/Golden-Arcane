...
execute if data storage goldark:settings { verbose_mode: true } run function goldark:__core/utils/log_message { message: "You have been transformed into a Wolf.", color: "gray" }