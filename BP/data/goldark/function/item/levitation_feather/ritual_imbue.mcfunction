...
## * 
## * Imbues a feather with Divine energy, converting it into a rare artifact.
...
particle white_smoke ~ ~0.5 ~ 0.05 0.05 0.05 0.01 1

particle small_flame ^ ^0.1 ^0.5 0.05 0.1 0.05 0.02 0
particle small_flame ^ ^0.1 ^-0.5 0.05 0.1 0.05 0.02 0
...
# Summon item
execute if score @s goldark.ability_timer matches 60 run function goldark:item/levitation_feather
