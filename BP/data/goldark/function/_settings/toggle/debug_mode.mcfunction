...
# Off
execute if data storage goldark:settings { debug_mode: true } run function goldark:__core/utils/log_message { message: '"Disabled Debug Mode."' }
...
# On
function goldark:__core/utils/log_message { message: '"Enabled Debug Mode."' }
