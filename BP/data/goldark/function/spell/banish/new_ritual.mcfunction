...
## Ignore if no valid Werewoof player is nearby
...
# Consume EXP
xp add @p[tag=goldpaths.is_werewoof, tag=!goldpaths.is_transformed, distance=..8] -10 points
